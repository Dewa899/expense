									...
									<div className="flex justify-end items-center mt-4">
										<div className="flex gap-2">
											...
											<Dialog open={isSyncModalOpen} onOpenChange={setIsSyncModalOpen}>
												<DialogTrigger render={<Button size="sm" variant="secondary" onClick={handleGeneralSyncClick} className="bg-black/10 hover:bg-black/20 text-black border-none rounded-full font-bold px-3 cursor-pointer" />}>
